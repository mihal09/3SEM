...
public class ReportGeneratorTest extends AbstractReportingTest{
	...
	public void testCreateJSONReport() {
		...
		Report generatedReport = reportFactory.getReport(reportData, "JSON");
	...
	public void testCreateXMLReport() {
		ReportData reportData = createDummyReportData();
		ReportFactory reportFactory = new ReportFactory();
		Report generatedReport = reportFactory.getReport(reportData, "XML");
	...
	public void testCreateHTMLReport() {
		ReportData reportData = createDummyReportData();
		ReportFactory reportFactory = new ReportFactory();
		Report generatedReport = reportFactory.getReport(reportData, "HTML");
	...
	public void testCreatePDFReport() {
		ReportData reportData = createDummyReportData();
		ReportFactory reportFactory = new ReportFactory();
		Report generatedReport = reportFactory.getReport(reportData, "PDF");
